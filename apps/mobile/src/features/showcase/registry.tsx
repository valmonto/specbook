...
const AccordionDemo = () => (
  <Accordion type="single" collapsible defaultValue="a" className="w-full">
    <AccordionItem value="a">
      <AccordionTrigger>
        <Text className="font-medium text-foreground">Is it accessible?</Text>
      </AccordionTrigger>
      <AccordionContent>
        <Text className="text-muted-foreground">
          Yes — it follows WAI-ARIA patterns for full keyboard and screen-reader support.
        </Text>
      </AccordionContent>
    </AccordionItem>
    <AccordionItem value="b">
      <AccordionTrigger>
        <Text className="font-medium text-foreground">Is it themed?</Text>
      </AccordionTrigger>
      <AccordionContent>
        <Text className="text-muted-foreground">
          Yes — it uses your design tokens, so it adapts to any palette and to dark mode.
        </Text>
      </AccordionContent>
    </AccordionItem>
    <AccordionItem value="c" className="border-b-0">
      <AccordionTrigger>
        <Text className="font-medium text-foreground">Is it animated?</Text>
      </AccordionTrigger>
      <AccordionContent>
        <Text className="text-muted-foreground">
          Yes — expanding and collapsing is smoothly animated with Reanimated.
        </Text>
      </AccordionContent>
    </AccordionItem>
  </Accordion>
...
const AlertDemo = () => (
  <View className="w-full gap-3">
    ...
    <Alert icon={Info} variant="info">
      ...
      <AlertDescription>Version 2.1 is ready to install.</AlertDescription>
    </Alert>
    ...
    <Alert icon={TriangleAlert} variant="warning">
      ...
      <AlertDescription>You&apos;ve used 90% of your quota.</AlertDescription>
    </Alert>
...
const AvatarDemo = () => (
  <View className="flex-row items-center gap-5">
    ...
    <Avatar alt="Circle" className="size-10">
      ...
      <AvatarFallback>
        <Text className="text-xs font-medium">CN</Text>
      </AvatarFallback>
    </Avatar>
    {/* rounded square */}
    ...
    <View className="flex-row">
      <View className="rounded-full bg-background p-0.5">
        <Avatar alt="1" className="size-10">
          ...
          <AvatarFallback>
            <Text className="text-xs font-medium">AL</Text>
          </AvatarFallback>
        </Avatar>
      </View>
      <View className="-ml-3 rounded-full bg-background p-0.5">
        <Avatar alt="2" className="size-10">
          ...
          <AvatarFallback>
            <Text className="text-xs font-medium">GH</Text>
          </AvatarFallback>
        </Avatar>
      </View>
      <View className="-ml-3 rounded-full bg-background p-0.5">
  ...
  <Timeline
    items={[
      ...
      },
      {
        ...
        tone: 'muted',
        title: 'Invoice sent',
        description: '#INV-2043 to Acme Co.',
        time: '9:30 AM',
      },
...
const RECORD_GROUPS: { title: string; total: string; items: ListItemProps[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        iconTone: 'muted',
        title: 'Spotify',
        description: '8:03 AM · Subscription',
        value: '−$13.50',
        caption: 'Completed',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        iconTone: 'muted',
        title: 'Netflix',
        description: '6:41 PM · Subscription',
        value: '−$15.99',
        caption: 'Pending',
      },
    ],
...
const RecordListDemo = () => (
  <View className="w-full gap-4">
    <Text variant="muted" className="text-xs">
      Swipe a row, or tap ⋮ for actions
    </Text>
    {RECORD_GROUPS.map((g) => (
            ...
            items: [
              {
                icon: CalendarDays,
                label: 'Open calendar',
                onSelect: () => toast.info('Calendar'),
              },
              {
                icon: Mail,
                label: 'Search email',
                keywords: ['inbox', 'mail'],
                onSelect: () => toast.info('Email'),
              },
              {
                icon: Users,
                label: 'Invite teammate',
                onSelect: () => toast.success('Invite sent'),
              },
            ],
          },
          {
            ...
            items: [
              {
                ...
                shortcut: '⌘P',
                onSelect: () => toast.info('Privacy'),
              },
              {
                icon: Bell,
                label: 'Notifications',
                shortcut: '⌘N',
                onSelect: () => toast.info('Notifications'),
              },
            ],
          },
        ]}
    ...
    <Collapsible open={open} onOpenChange={setOpen} className="w-full gap-2">
      ...
      <CollapsibleContent className="gap-2">
        <View className="rounded-lg border border-border p-3">
          <Text variant="muted">@radix-ui/primitives</Text>
        </View>
        <View className="rounded-lg border border-border p-3">
          <Text variant="muted">@stitches/react</Text>
        </View>
      </CollapsibleContent>
    </Collapsible>
  );
  ...
  <View className="w-full flex-row flex-wrap gap-2">
    ...
    >
      <View className="gap-4">
        <View className="gap-2">
          <Label>Name</Label>
          <Input icon={Info} placeholder="Ada Lovelace" />
        </View>
        <View className="gap-2">
        ...
        {RELEASES.map((r) => (
          <View key={r.v} className="gap-2">
            ...
            {[
              ...
              'Resolved an edge case in billing totals.',
            ].map((line) => (
    ...
    <HoverCardContent className="w-72">
      <View className="flex-row gap-3">
        <Avatar alt="expo" className="size-11">
          ...
          <AvatarFallback>
            <Text className="text-xs font-medium">EX</Text>
          </AvatarFallback>
        </Avatar>
  ...
  return (
    <View className="w-full gap-4">
      <View className="gap-2">
        ...
        <Text variant="muted" className="text-xs">
          {code.length === 6 ? 'Verified ✓' : `${code.length}/6 entered`}
        </Text>
      </View>
      <View className="gap-2">
        <Text className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
...
const RadioGroupDemo = () => {
  ...
  return (
    <RadioGroup
      ...
      className="w-full flex-row flex-wrap gap-x-6 gap-y-3"
    >
      {[
        ['compact', 'Compact'],
        ...
        <View key={val} className="shrink-0 flex-row items-center gap-2.5">
          ...
          <Label onPress={() => setValue(val)} className="pr-1">
            {label}
          </Label>
        </View>
      ))}
...
const ToastDemo = () => (
  <View className="w-full flex-row flex-wrap gap-2">
    <Button
      size="sm"
      variant="outline"
      onPress={() => toast.success('Changes saved', { description: 'Your profile is up to date.' })}
    >
      <Text>Success</Text>
    </Button>
    <Button
      size="sm"
      variant="outline"
      onPress={() => toast.error('Something went wrong', { description: 'Please try again.' })}
    >
      <Text>Error</Text>
    </Button>
    <Button size="sm" variant="outline" onPress={() => toast.warning('Low storage')}>
      <Text>Warning</Text>
    </Button>
    <Button size="sm" variant="outline" onPress={() => toast.info('Update available')}>
      <Text>Info</Text>
    </Button>
    <Button
      size="sm"
      variant="outline"
      onPress={() =>
        toast('Event created', { action: { label: 'Undo', onClick: () => toast('Reverted') } })
      }
    >
      <Text>Action</Text>
    </Button>
...
const TooltipDemo = () => (
  <Tooltip>
    ...
    <TooltipContent>
      <Text className="text-xs">Add to library</Text>
    </TooltipContent>
  </Tooltip>
);
