...
/**
 * The v2 project view: a pipeline strip + one stage-filtered list, replacing
 * the six-column board. Opening the page lands on the first stage that needs
 * the human (review → blocked → approved), because that is the question the
 * view exists to answer. The legacy board stays at /projects/:id.
 */
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 text-sm text-muted-foreground">
        ...
        <Link to={`/projects/${project.id}`} className="ml-auto hover:text-foreground">
          {t(k.tasks.v2.legacyView)}
        </Link>
      </div>
